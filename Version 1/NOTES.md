...
### 2026-07-08
- Optimized this `Version 1` copy by deferring Projects/Interests images until their sections open and replacing the 1.9 MB credit-card essay thumbnail with a 72 KB JPEG; bumped `site.js` to `v=30`.
- Removed the hidden Interests page markup and disabled the old `#interests` route so it is no longer visitor-facing.
